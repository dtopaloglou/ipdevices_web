<aside class="sidebar">
    <div class="sidebar-container">
        <div class="sidebar-header">
            <div class="brand">
                <div class="logo"> <span class="l l1"></span> <span class="l l2"></span> <span class="l l3"></span> <span class="l l4"></span> <span class="l l5"></span><span class="l l6"></span> </div> <?php echo CoreConfig::settings()['appname']; ?></div>
        </div>
        <nav class="menu">
            <ul class="nav metismenu" id="sidebar-menu">
                ...
                <li class="_mydevices">
                    <a href="../devices.php"> <i class="fa fa-gears"></i> My Devices   </a> </li>
                    </ul>
                </li>
